Rectangle::Application.routes.draw do
  ...
  # first created -> highest priority.
	...
	post '/website/:id/comments/new' => 'comments#commit_new', :as => :commit_new_comment
	#page to create reply for a existing comment
	get '/comment/:id/comments/new' => 'comments#disply_new_reply', :as => :display_new_reply
	post '/comment/:id/comments/new' => 'comments#commit_new_reply', :as => :commit_new_reply
  ...
  post '/websites/new' => 'websites#commit_new', :as => :commit_new_website
end
